--Esse arquivo é um arquivo de callBack - Não é uma migração
--Uma das fases que o FlyWay roda é chamado de afterMigrate
--Depois que todas as migrações rodam esse arquivo é chamado
