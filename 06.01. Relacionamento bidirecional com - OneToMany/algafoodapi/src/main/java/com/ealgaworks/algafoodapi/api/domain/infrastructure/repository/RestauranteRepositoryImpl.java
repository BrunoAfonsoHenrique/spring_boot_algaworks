...
import com.ealgaworks.algafoodapi.api.domain.infrastructure.repository.specification.RestaurantesSpecifications;
...
public class RestauranteRepositoryImpl implements RestauranteRepositoryQueries {
    ...
    @Lazy // Só instancia no momento em que precisar
    @Autowired
    ...
    public List<Restaurante> findComFreteGratis(String nome) {
        return restauranteRepository.findAll(RestaurantesSpecifications.comFreteGratis()
                .and(RestaurantesSpecifications.comNomeSemelhante(nome)));
    }
